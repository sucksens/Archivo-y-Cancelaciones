...
<head>
    ...
    <title>Método No Permitido - <?= APP_NAME ?></title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="text-center">
        ...
        <h1 class="text-4xl font-bold text-gray-900 mb-2">405</h1>
        <h2 class="text-xl font-semibold text-gray-700 mb-4">Método No Permitido</h2>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">
            El método HTTP que estás intentando usar no está permitido para esta URL.
        </p>

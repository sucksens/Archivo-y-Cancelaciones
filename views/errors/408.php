...
<head>
    ...
    <title>Tiempo de Espera Agotado - <?= APP_NAME ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="text-center">
        <div class="inline-flex items-center justify-center w-24 h-24 bg-rose-100 rounded-full mb-6">
            <svg class="w-12 h-12 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
            </svg>
        </div>
        
        <h1 class="text-4xl font-bold text-gray-900 mb-2">408</h1>
        <h2 class="text-xl font-semibold text-gray-700 mb-4">Tiempo de Espera Agotado</h2>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">
            La solicitud ha tardado demasiado tiempo en procesarse. Por favor, intenta de nuevo.
        </p>
